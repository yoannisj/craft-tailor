...
class TailorTwigExtension extends AbstractExtension
{
    ...
    public function getFunctions()
    {
        return [
            ...
            // {{ isQuery(value) }}
            new TwigFunction('isQuery', [$this, 'isQuery'], []),

            // {{ isElement(value) }}
            new TwigFunction('isElement', [$this, 'isElement'], []),

            // {{ isBlock(value) }}
            new TwigFunction('isBlock', [$this, 'isBlock'], []),

            // {{ isGlobalset(value) }}
            new TwigFunction('isGlobalset', [$this, 'isGlobalset'], []),

            // {{ isEntry(value) }}
            new TwigFunction('isEntry', [$this, 'isEntry'], []),

            // {{ isAsset(value) }}
            new TwigFunction('isAsset', [$this, 'isAsset'], []),

            // {{ isCategory(value) }}
            new TwigFunction('isCategory', [$this, 'isCategory'], []),

            // {{ isTag(value) }}
            new TwigFunction('isTag', [$this, 'isTag'], []),

            // {{ isMatrixblock(value) }}
            new TwigFunction('isMatrixBlock', [$this, 'isMatrixBlock'], []),
    ...
    /**
     * Checks wether given value is a database Query builder
     *
     * @param mixed $value
     *
     * @return bool
    ...
    /**
     * Checks wether given value is a a craft Element
     *
     * @param mixed $value
     *
     * @return bool
    ...
    /**
     * Checks wether given value is a a craft Block Element
     *
     * @param mixed $value
     *
     * @return bool
    ...
    /**
     * Checks wether given value is a a craft Globalset element
     *
     * @param mixed $value
     *
     * @return bool
    ...
    /**
     * Checks wether given value is a a craft Entry element
     *
     * @param mixed $value
     *
     * @return bool
    ...
    /**
     * Checks wether given value is a a craft Asset element
     *
     * @param mixed $value
     *
     * @return bool
    ...
    /**
     * Checks wether given value is a a craft Category element
     *
     * @param mixed $value
     *
     * @return bool
    ...
    /**
     * Checks wether given value is a a craft Tag element
     *
     * @param mixed $value
     *
     * @return bool
    ...
    /**
     * Checks wether given value is a a craft MatrixBlock element
     *
     * @param mixed $value
     *
     * @return bool
    ...
    /**
     * Checks wether given value is a a craft User element
     *
     * @param mixed $value
     *
     * @return bool
